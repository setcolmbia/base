...
class ivrsController extends Ivrs{
    /**
    ...
    public function list(){
        ...
        require_once 'views/ivrs/list.php';
    ...
    public function create(){
        require_once 'views/layouts/header.php';
        require_once 'views/layouts/sidemenu.php';
        require_once 'views/ivrs/create.php';
        require_once 'views/layouts/footer.php';
    }
    ...
    public function store(){
	    ...
	    header('location: ?controller=ivrs&method=list');	
        }else{
    ...
    public function edit(){        
        $ivrs = parent::find($_GET['id']);
        require_once 'views/layouts/header.php';
        require_once 'views/layouts/sidemenu.php';
        require_once 'views/ivrs/edit.php';
        require_once 'views/layouts/footer.php';
    }
    ...
    public function update(){
	    ...
	    header('location:?controller=ivrs&method=list');
            /*if(telephonyController::generateRoboivrs()){
                $command = "reload";
    ...
    public function delete(){
        ...
        echo parent::delete_register($_GET) ? header('location: ?controller=ivrs&method=list') : 'Error en el delete';
    }
