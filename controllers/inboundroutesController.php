...
class inboundroutesController extends Inboundroutes{
    /**
    ...
    public function list(){
        ...
        require_once 'views/inboundroutes/list.php';
    ...
    public function create(){
        require_once 'views/layouts/header.php';
        require_once 'views/layouts/sidemenu.php';
        require_once 'views/inboundroutes/create.php';
        require_once 'views/layouts/footer.php';
    }
    ...
    public function store(){
	    ...
	    header('location: ?controller=inboundroutes&method=list');	
        }else{
    ...
    public function edit(){        
        $inboundroutes = parent::find($_GET['id']);
        require_once 'views/layouts/header.php';
        require_once 'views/layouts/sidemenu.php';
        require_once 'views/inboundroutes/edit.php';
        require_once 'views/layouts/footer.php';
    }
    ...
    public function update(){
	    ...
	    header('location:?controller=inboundroutes&method=list');
            /*if(telephonyController::generateRoboinboundroutes()){
                $command = "reload";
    ...
    public function delete(){
        ...
        echo parent::delete_register($_GET) ? header('location: ?controller=inboundroutes&method=list') : 'Error en el delete';
    }
