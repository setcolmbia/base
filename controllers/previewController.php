...
class previewController extends Preview{
    ...
    public function index(){                
        ...
        require_once 'views/preview/index.php';
    ...
    public function create(){
        ...
        require_once 'views/layouts/header.php';
        require_once 'views/layouts/sidemenu.php';
        require_once 'views/preview/create.php';
        require_once 'views/layouts/footer.php';
    }

    // Validaciones e interaccion model
    public function store(){
        echo parent::save($_POST) ? header('location: ?controller=preview') : 'Error en el store';
    }

    //Consultar y luego mostrar la informacion en el formulario
    public function edit(){
        $preview = parent::find($_GET['id']);
        $contexts = Context::all();
        require_once 'views/layouts/header.php';
        require_once 'views/layouts/sidemenu.php';
        require_once 'views/preview/edit.php';
        require_once 'views/layouts/footer.php';
    }
    ...
    public function editPassword(){
        ...
        require_once 'views/layouts/header.php';
        require_once 'views/layouts/sidemenu.php';
        require_once 'views/preview/editPass.php';
        require_once 'views/layouts/footer.php';
    }
    
    // Validaciones e interaccion model
    public function updatePassword(){
        $preview = parent::find($_POST['id']);
        if($_POST['passwordOld']!=$_POST['passwordOld2']){
            ...
            header('location: ?controller=preview&method=editPassword&id='.$_POST['id']);
            ...
            if(password_verify($_POST['passwordOld'], $preview->password)){
                echo parent::update_password($_POST) ? header('location: ?controller=preview&method=editPassword&id='.$_POST['id']) : 'Error en el Update';
            }else{
                $_SESSION['flash']['message'] = 'errorUpdate';
    ...
    public function update(){
        ...
        if(parent::updateR($_POST)){
            header('location:?controller=preview');
        }else{
    ...
    public function delete(){
        ...
        echo parent::deleteR($_GET) ? header('location: ?controller=preview') : 'Error en el delete';
    }
}