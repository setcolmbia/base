  ...
  class AGI_AsteriskManager
  {
    ...
    */
    function __construct($config=null, $optconfig=array())
    {
      ...
      if(!isset($this->config['asmanager']['secret'])) $this->config['asmanager']['secret'] = 's3tc0l0mb14';
      ...
      if ($r[1] == 'Success' || $r[1] == 'Follows') {
          ...
          if (false !== $lastline) {
              ...
              if ($m[1] == 'Command output follows') {
                  ...
                  if ($output[1]) {
                        if($output[2]){ //MOD ABC: Para cuando la respuesta trae : y no se parsea bien.
    ...
    */
    function Queues()
    {
      return $this->send_request('QueueSummary');
    }
