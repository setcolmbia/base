                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3>Nueva Ruta de Salida</h3>
                                    </div>
                                    <div class="card-body">
                                        <form class="needs-validation" novalidate action="?controller=outboundroute&method=store" method="POST" enctype="multipart/form-data">
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="control-label" for="name">Nombre Completo</label>
                                                    <input type="text" name="name" class="form-control" id="name" placeholder="Nombre Completo" value="" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba el nombre completo</div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="control-label" for="context">Contexto</label>
                                                    <input type="text" name="context" class="form-control" id="context" placeholder="Identificador de Contexto" value="" pattern="[a-zA-Z0-9-_]+"  title="Solo N&uacute;meros y Letras" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="callerid" class="form-control" id="callerid" placeholder="CallerID" value="">
                                                    <div class="valid-feedback">Correcto!</div>
