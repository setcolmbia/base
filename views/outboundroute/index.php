                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="?controller=outboundroute&method=create" data-toggle="tooltip" title="Agregar Ruta de Salida" data-placement="bottom" class="btn btn-primary">
                                            <i class="fas fa-plus-circle"></i> Agregar Ruta de Salida
                                        </a>
                                        <a href="?controller=outboundroute&method=reload" data-toggle="tooltip" title="Recargar Configuración" data-placement="bottom" class="btn btn-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="tabla-loader" class="display table table-striped table-hover" >
                                                ...
                                                <tbody>
                                                <?php foreach(parent::all() as $outboundroute):  ?>
                                                    <tr>
                                                        <td><?= $outboundroute->name ?></td>
                                                        <td><?= $outboundroute->context ?></td>
                                                        <td><?= $outboundroute->callerid ?></td>
                                                        <td><?php echo ($outboundroute->active==1)?"SI":"NO"; ?></td>
                                                        <td width="200" class="table__options">
                                                            <a href="?controller=outboundroute&method=edit&id=<?= $outboundroute->id ?>" data-toggle="tooltip" title="Editar Ruta" data-placement="bottom" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Editar</a>
                                                            <a href="?controller=outboundroute&method=delete&id=<?= $outboundroute->id ?>" data-toggle="tooltip" title="Eliminar Ruta" data-placement="bottom" class="btn btn-danger btn-sm" onclick='return asegurar()'><i class="fa fa-trash"></i> Borrar</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                                </tbody>
