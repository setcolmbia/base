                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="?controller=sip&method=create" data-toggle="tooltip" title="Agregar Extensión SIP" data-placement="bottom" class="btn btn-primary">
                                            <i class="fas fa-plus-circle"></i> Agregar Extensión SIP
                                        </a>
                                        <a href="?controller=sip&method=reload" data-toggle="tooltip" title="Recargar Configuración" data-placement="bottom" class="btn btn-primary">
                                            ...
                                            <table id="basic-datatables" class="display table table-striped table-hover" >
                                                ...
                                                <?php foreach(parent::all() as $sip):  ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $sip->context ?></td>
                                                        <td><?= $sip->allow ?></td>
                                                        <td><?php echo ($sip->active==1)?"SI":"NO"; ?></td>
                                                        <td width="200" class="table__options">
                                                            <a href="?controller=sip&method=edit&id=<?= $sip->id ?>" data-toggle="tooltip" title="Editar Extensión" data-placement="bottom" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Editar</a>
                                                            <a href="?controller=sip&method=delete&id=<?= $sip->id ?>" data-toggle="tooltip" title="Eliminar Extensión" data-placement="bottom" class="btn btn-danger btn-sm" onclick='return asegurar()'><i class="fa fa-trash"></i> Borrar</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                                </tbody>
