                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3>Nueva Extensión SIP</h3>
                                    </div>
                                    <div class="card-body">
                                        <form class="needs-validation" novalidate action="?controller=sip&method=store" method="POST" enctype="multipart/form-data">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="name" class="form-control" id="name" placeholder="Extensión" value="" pattern="[1-9]{1}[0-9]{2,9}"  title="Solo N&uacute;meros entre 100 y 9999999999" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="allow" class="form-control" id="allow" value="gsm;ulaw;alaw" placeholder="Codecs" value="" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="secret" class="form-control" id="secret" placeholder="Clave SIP" value="<?= parent::generatePassword() ?>" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba la clave</div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="control-label" for="call_limit">Limite de Canales</label>
                                                    <input type="number" step="1" name="call_limit" class="form-control" id="call_limit" placeholder="Limite de Canales" value="" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                            ...
                                            <button class="btn btn-primary" type="submit">Crear Extensión</button>
