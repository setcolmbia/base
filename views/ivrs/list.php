                ...
                <div class="content">
                    <div class="page-inner">
                        ...
                        if (isset($_POST['name']) ) {
                            ...
                            die("SIN DATOS PARA BUSCAR IVRs 1");
                        }
                        if($_POST['name'] == '' ){
                            die("SIN DATOS PARA BUSCAR IVRs 2");
                        }
                        ?>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="?controller=ivrs&method=create" data-toggle="tooltip" title="Agregar IVR" data-placement="bottom" class="btn btn-primary">
                                            <i class="fas fa-user-plus"></i> Agregar IVR
                                        </a>
                                        <a href="?controller=ivrs&method=reload" data-toggle="tooltip" title="Recargar Configuración" data-placement="bottom" class="btn btn-primary">
                                        ...
                                        <div class="table-responsive" style="display: none;">
                                            <table id="tabla-loader-100" class="table table-hover table-striped table-binvoiceed display" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>Tiempo Máx</th>
                                                    <th>Grabación</th>
                                                    <th>Marcación Directa</th>
                                                    <th>Acciones</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                
                                                <?php foreach(parent::findByAny($name) as $ivrs):  ?>
                                                    <?php 
                                                        $recording = parent::recording($ivrs->recording);
                                                        //$outboundroute = Outboundroute::find($ivrs->route);
                                                    ?>
                                                    <tr>
                                                        <td><?= $ivrs->id ?></td>
                                                        <td><?= $ivrs->name ?></td>
                                                        <td><?= $ivrs->description ?></td>
                                                        <td><?= $ivrs->number ?></td>
                                                        <td><?= $ivrs->timeout ?></td>
                                                        <td><?= $recording->name ?></td>
                                                        <td><?= $ivrs->directDial ?></td>
                                                        <td width="200" class="table__options">
                                                            <a href="?controller=ivrs&method=edit&id=<?= $ivrs->id ?>" data-toggle="tooltip" title="Editar la Campaña" data-placement="bottom" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Editar</a>
                                                            <a href="?controller=ivrs&method=delete&id=<?= $ivrs->id ?>" data-toggle="tooltip" title="Eliminar la Campaña" data-placement="bottom" class="btn btn-danger btn-sm" onclick='return asegurar()'><i class="fa fa-trash"></i> Borrar</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                                </tbody>
