                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="?controller=contact&method=create" data-toggle="tooltip" title="Agregar Usuario" data-placement="bottom" class="btn btn-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive" style="display: none;">
                                            <table id="tabla-loader-100" class="table table-hover table-striped table-binvoiceed display" width="100%">
                                                ...
                                                <tbody>
                                                <?php foreach(parent::all() as $contact):  ?>
                                                    <tr>
                                                        ...
                                                        <td width="200" class="table__options">
                                                            <a href="?controller=contact&method=edit&id=<?= $contact->id ?>" data-toggle="tooltip" title="Editar el Cliente" data-placement="bottom" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Editar</a>
                                                            <a href="?controller=contact&method=delete&id=<?= $contact->id ?>" data-toggle="tooltip" title="Eliminar el Cliente" data-placement="bottom" class="btn btn-danger btn-sm" onclick='return asegurar()'><i class="fa fa-trash"></i> Borrar</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                                </tbody>
