                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="needs-validation" novalidate action="?controller=contact&method=update&id=<?= $contact->id ?>" method="POST" enctype="multipart/form-data">
                                            <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="fullName" name="fullName" placeholder="" value="<?= $contact->fullName ?>">
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba el Nombre</div>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="identificationNumber">Número de Identificación</label>
                                                    <input type="text" class="form-control" id="identificationNumber" name="identificationNumber" placeholder="" pattern="[0-9]+"  value="<?= $contact->identificationNumber ?>" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="checkDigit" name="checkDigit" placeholder="" pattern="[0-9]{1}"  value="<?= $contact->checkDigit ?>">
                                                    <div class="valid-feedback">Correcto!</div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <select type="select" id="identificationType" name="identificationType" class="custom-select" required>
                                                        ...
                                                        <option <?php echo ($contact->identificationType==13)?"selected":""; ?> value="13">Cédula de Ciudadanía</option>
                                                        <option <?php echo ($contact->identificationType==31)?"selected":""; ?> value="31">NIT</option>
                                                        <option <?php echo ($contact->identificationType==22)?"selected":""; ?> value="22">Cédula de Extranjería</option>
                                                    </select>
                                                    <div class="valid-feedback">Correcto!</div>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <select type="select" id="country" name="country" class="custom-select" required>
                                                        <option value="<?= $contact->countryCode ?>"><?= $contact->countryCode ?></option>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <select type="select" id="state" name="state" class="custom-select" required>
                                                        <option value="<?= $contact->stateCode ?>"><?= $contact->stateName ?></option>
                                                    </select>
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Seleccione un opción</div>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <select type="select" id="city" name="city" class="custom-select" required>
                                                        <option value="<?= $contact->cityCode ?>"><?= $contact->cityName ?></option>
                                                    </select>
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Seleccione un opción</div>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="address" name="address" placeholder="Dirección Principal" value="<?= $contact->address ?>" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba la Dirección</div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="address2">Dirección 2</label>
                                                    <input type="text" class="form-control" id="address2" name="address2" placeholder="Dirección Complementaria / Alternativa" value="<?= $contact->address2 ?>">
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba la Dirección</div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email" class="form-control" id="email" name="email" placeholder="" aria-describedby="inputGroupPrepend" value="<?= $contact->email ?>" required>
                                                        <div class="valid-feedback">Correcto!</div>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="phone" name="phone" placeholder="Teléfono Principal" value="<?= $contact->phone ?>">
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba el Número de Teléfono.</div>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="phone2">Número de Teléfono 2</label>
                                                    <input type="text" class="form-control" id="phone2" name="phone2" placeholder="Teléfono Alternativo" value="<?= $contact->phone2 ?>">
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba el Número de Teléfono.</div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea class="form-control" id="observations" name="observations" placeholder="Observaciones o Anotaciones"><?= $contact->observations ?></textarea>
                                                </div>
                                            </div>
