                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="needs-validation" novalidate action="?controller=agent&method=store" method="POST" enctype="multipart/form-data">
                                            <div class="form-row">
                                            ...
                                            <button class="btn btn-primary" type="submit">Crear Agente</button>
