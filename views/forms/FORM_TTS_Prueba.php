<div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="needs-validation" novalidate action="?controller=form&method=storeDynamic&id=9" method="POST" enctype="multipart/form-data">
                                            <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12 mb-1">
                                                    ...
                                                    <input type="text" class="form-control" id="Cdula" name="Cdula" value="<?= isset($_GET['idLead']) ? $lead->Cdula:'' ?>" required >
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12 mb-3 form-group">
                                                    ...
                                                    <select type="select" id="Tipo" name="Tipo" class="custom-select" >
