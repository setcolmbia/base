                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="?controller=form&method=create" data-toggle="tooltip" title="Nuevo Formulario" data-placement="bottom" class="btn btn-primary">
                                            <i class="fas fa-plus-circle"></i> Agregar Formulario
                                        </a>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive" style="display: none;">
                                            <table id="tabla-loader" class="display table table-striped table-hover" >
                                                ...
                                                <tbody>
                                                <?php foreach(parent::all() as $form):  ?>
                                                    <tr>
                                                        <td><?= $form->name ?></td>
                                                        <td><?= $form->description ?></td>
                                                        <td><?php echo ($form->active==1)?"SI":"NO"; ?></td>
                                                        <td width="200" class="table__options">
                                                            <a href="?controller=form&method=edit&id=<?= $form->id ?>" data-toggle="tooltip" title="Editar Formulario" data-placement="bottom" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Editar</a>
                                                            <a href="?controller=form&method=fields&id=<?= $form->id ?>" data-toggle="tooltip" title="Ajustar Campos" data-placement="bottom" class="btn btn-success btn-sm"><i class="fa fa-columns"></i> Campos</a>
                                                            <a href="?controller=form&method=delete&id=<?= $form->id ?>" data-toggle="tooltip" title="Eliminar Formulario" data-placement="bottom" class="btn btn-danger btn-sm" onclick='return asegurar()'><i class="fa fa-trash"></i> Borrar</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                                </tbody>
