                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="needs-validation" novalidate action="?controller=form&method=store" method="POST" enctype="multipart/form-data">
                                            <div class="form-row">
                                                <div class="col-md-6 mb-1 form-group">
                                                    <label for="name">Nombre</label>
                                                    <input type="text" class="form-control" id="name" name="name" placeholder="Nombre del Formulario" pattern="[a-zA-Z0-9-_]+" title="No use espacios ni caracteres especiales" required>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12 mb-3 form-group">
                                                    ...
                                                    <textarea id="speech" name="speech" class="form-control"></textarea>
                                                </div>
                                            </div>
...
<!--                                            <legend>Campos</legend>
                                                <p> 
                                                        <input type="button" class="btn btn-primary btn-sm add-more" value="Agregar Campo"/>
                                                </p>
                                            
                                            <div class="copy" style="display: none;">
                                            <div class="form-row control-group">
                                                <div class="col-md-3 mb-1">
                                                    <input type="text" class="fieldName form-control" id="fieldName" name="fieldName[]" placeholder="Nombre Campo">
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba un Valor</div>
                                                </div>
                                                <div class="col-md-3 mb-1">
                                                    <select type="select" id="fieldType" name="fieldType[]" class="fieldType custom-select">
                                                        <option value="">Seleccione...</option>
                                                ...
                                                <div class="col-md-1 mb-1">
                                                    <select type="select" id="fieldLength" name="fieldLength[]" class="fieldLength custom-select">
                                                        <option value="">Seleccione...</option>
                                                    ...
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba una Cantidad</div>
                                                </div>
                                                <div class="col-md-1 mb-1">
                                                    <select type="select" id="fieldReadonly" name="fieldReadonly[]" class="fieldReadonly custom-select">
                                                        <option value="">Seleccione...</option>
                                                ...
                                                <div class="col-md-1 mb-1">
                                                    <select type="select" id="fieldMultiple" name="fieldMultiple[]" class="fieldMultiple custom-select">
                                                        <option value="">Seleccione...</option>
                                                        <option value="SI">SI</option>
                                                        <option value="NO">NO</option>
                                                    </select>
                                                ...
                                                <div class="col-md-1 mb-1">
                                                    <select type="select" id="fieldRequired" name="fieldRequired[]" class="fieldRequired custom-select">
                                                        <option value="">Seleccione...</option>
                                                        <option value="SI">SI</option>
                                                        <option value="NO">NO</option>
                                                    </select>
				            ...
				            <div class="form-row control-group">
                                            ...
                                            <button class="btn btn-primary" type="submit">Crear Formulario</button>
