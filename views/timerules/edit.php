                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3>Edición del Horario</h3>
                                    </div>
                                    <div class="card-body">
                                        <form class="needs-validation" novalidate action="?controller=timerules&method=update&id=<?= $timerules->id ?>" method="POST" enctype="multipart/form-data">
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    <label for="name">Nombre</label>
                                                    <input type="text" class="form-control" id="name" name="name" placeholder="Escriba el nombre del Horario" value="<?= $timerules->name ?>" title="Escriba el nombre del Horario" pattern="[A-Za-z0-9_ ]+" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba el nombre del Horario</div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="description">Descripción</label>
                                                    <textarea id="description" name="description" class="form-control" rows="2" required><?= $timerules->description ?></textarea>
                                                    <div class="valid-feedback">Correcto!</div>
                                            ...
                                            <div class="form-row">
                                                <?php
                                                    $porciones = explode(":", $timerules->startMonFri);
                                                    $startMonFri1 = $porciones[0]; // porción1
                                                    $startMonFri2 = $porciones[1]; // porción2
                                                ?>
                                                <div class="col-md-6 mb-3">
                                                    <label for="recording">Hora Inicial(Horas)</label>
                                                    <select type="select" id="startMonFri1" name="startMonFri1" class="custom-select">
                                                        <option value="<?= $startMonFri1 ?>"><?= $startMonFri1 ?></option>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select type="select" id="startMonFri2" name="startMonFri2" class="custom-select">
                                                        <option value="<?= $startMonFri2 ?>"><?= $startMonFri2 ?></option>
                                            ...
                                            <div class="form-row">
                                                <?php
                                                    $porciones = explode(":", $timerules->endMonFri);
                                                    $endMonFri1 = $porciones[0]; // porción1
                                                    $endMonFri2 = $porciones[1]; // porción2
                                                ?>
                                                <div class="col-md-6 mb-3">
                                                    <label for="recording">Hora Final(Horas)</label>
                                                    <select type="select" id="endMonFri1" name="endMonFri1" class="custom-select">
                                                        <option value="<?= $endMonFri1 ?>"><?= $endMonFri1 ?></option>
                                                        <option value="0">0</option>
                                                        <option value="1">1</option>
                                                        <option value="2">2</option>
                                                        <option value="3">3</option>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select type="select" id="endMonFri2" name="endMonFri2" class="custom-select">
                                                        <option value="<?= $endMonFri2 ?>"><?= $endMonFri2 ?></option>
                                                        <option value="00">00</option>
                                                        <option value="05">05</option>
                                                        <option value="10">10</option>
                                                        <option value="15">15</option>
                                            ...
                                            <div class="form-row">
                                                <?php
                                                    $porciones = explode(":", $timerules->startSat);
                                                    $startSat1 = $porciones[0]; // porción1
                                                    $startSat2 = $porciones[1]; // porción2
                                                ?>
                                                <div class="col-md-6 mb-3">
                                                    <label for="recording">Hora Inicial(Horas)</label>
                                                    <select type="select" id="startSat1" name="startSat1" class="custom-select">
                                                        <option value="<?= $startSat1 ?>"><?= $startSat1 ?></option>
                                                        <option value="0">0</option>
                                                        <option value="1">1</option>
                                                        <option value="2">2</option>
                                                        <option value="3">3</option>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select type="select" id="startSat2" name="startSat2" class="custom-select">
                                                        <option value="<?= $startSat2 ?>"><?= $startSat2 ?></option>
                                                        <option value="00">00</option>
                                                        <option value="05">05</option>
                                                        <option value="10">10</option>
                                                        <option value="15">15</option>
                                            ...
                                            <div class="form-row">
                                                <?php
                                                    $porciones = explode(":", $timerules->endSat);
                                                    $endSat1 = $porciones[0]; // porción1
                                                    $endSat2 = $porciones[1]; // porción2
                                                ?>
                                                <div class="col-md-6 mb-3">
                                                    <label for="recording">Hora Final(Horas)</label>
                                                    <select type="select" id="endSat1" name="endSat1" class="custom-select">
                                                        <option value="<?= $endSat1 ?>"><?= $endSat1 ?></option>
                                                        <option value="0">0</option>
                                                        <option value="1">1</option>
                                                        <option value="2">2</option>
                                                        <option value="3">3</option>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select type="select" id="endSat2" name="endSat2" class="custom-select">
                                                        <option value="<?= $endSat2 ?>"><?= $endSat2 ?></option>
                                                        <option value="00">00</option>
                                                        <option value="05">05</option>
                                                        <option value="10">10</option>
                                                        <option value="15">15</option>
                                            ...
                                            <div class="form-row">
                                                <?php
                                                    $porciones = explode(":", $timerules->startSun);
                                                    $startSun1 = $porciones[0]; // porción1
                                                    $startSun2 = $porciones[1]; // porción2
                                                ?>
                                                <div class="col-md-6 mb-3">
                                                    <label for="recording">Hora Inicial(Horas)</label>
                                                    <select type="select" id="startSun1" name="startSun1" class="custom-select">
                                                        <option value="<?= $startSun1 ?>"><?= $startSun1 ?></option>
                                                        <option value="0">0</option>
                                                        <option value="1">1</option>
                                                        <option value="2">2</option>
                                                        <option value="3">3</option>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select type="select" id="startSun2" name="startSun2" class="custom-select">
                                                        <option value="<?= $startSun2 ?>"><?= $startSun2 ?></option>
                                                        <option value="00">00</option>
                                                        <option value="05">05</option>
                                                        <option value="10">10</option>
                                                        <option value="15">15</option>
                                            ...
                                            <div class="form-row">
                                                <?php
                                                    $porciones = explode(":", $timerules->endSun);
                                                    $endSun1 = $porciones[0]; // porción1
                                                    $endSun2 = $porciones[1]; // porción2
                                                ?>
                                                <div class="col-md-6 mb-3">
                                                    <label for="recording">Hora Final(Horas)</label>
                                                    <select type="select" id="endSun1" name="endSun1" class="custom-select">
                                                        <option value="<?= $endSun1 ?>"><?= $endSun1 ?></option>
                                                        <option value="0">0</option>
                                                        <option value="1">1</option>
                                                        <option value="2">2</option>
                                                        <option value="3">3</option>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select type="select" id="endSun2" name="endSun2" class="custom-select">
                                                        <option value="<?= $endSun2 ?>"><?= $endSun2 ?></option>
                                                        <option value="00">00</option>
                                                        <option value="05">05</option>
                                                        <option value="10">10</option>
                                                        <option value="15">15</option>
                                            ...
                                            <div class="form-row">
                                                <?php 
                                                    $option1 = $timerules->dest;
                                                    $idDest = $timerules->idDest;
                                                    if($idDest){
                                                        $dest = parent::findByOptions($option1,$idDest);
                                                        $idDest = '<option value="'.$dest->id.'">'.$dest->name.'</option>';
                                                    }else{
                                                        $idDest = '<option value="">Seleccione Destino.</option>';
                                                    }
                                                ?>
                                                <div class="col-md-6 mb-3">
                                            ...
                                            <div class="form-row">
                                                <?php 
                                                    $option2 = $timerules->destNO;
                                                    $idDestNO = $timerules->idDestNO;
                                                    if($idDestNO){
                                                        $destNO = parent::findByOptions($option2,$idDestNO);
                                                        $idDestNO = '<option value="'.$destNO->id.'">'.$destNO->name.'</option>';
                                                    }else{
                                                        $idDestNO = '<option value="">Seleccione Destino.</option>';
                                                    }
                                                ?>
                                                <div class="col-md-6 mb-3">
