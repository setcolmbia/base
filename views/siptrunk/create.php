                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3>Nueva Troncal SIP</h3>
                                    </div>
                                    <div class="card-body">
                                        <form class="needs-validation" novalidate action="?controller=siptrunk&method=store" method="POST" enctype="multipart/form-data">
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="control-label" for="fullname">Nombre Completo</label>
                                                    <input type="text" name="fullname" class="form-control" id="fullname" placeholder="Nombre Completo" value="" required>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="name" class="form-control" id="name" placeholder="Identificador" value="" pattern="[a-zA-Z0-9-_]+"  title="Solo N&uacute;meros y Letras" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="host" class="form-control" id="host" placeholder="Host Remoto" value="dynamic" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba el Host</div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="control-label" for="port">Puerto UDP</label>
                                                    <input type="number" name="port" class="form-control" id="port" placeholder="Puerto" value="5060" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" step="1" name="call_limit" class="form-control" id="call_limit" placeholder="Limite de Canales" value="30" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select  name="allow[]" class="custom-select" id="allow" required multiple>
                                                        <option value='alaw' selected>G.711 Alaw</option>
                                                        <option value='ulaw' selected>G.711 Ulaw</option>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="secret" class="form-control" id="secret" placeholder="Clave SIP" value="" disabled="disabled">
                                                    <div class="valid-feedback">Correcto!</div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="fromuser" class="form-control" id="fromuser" placeholder="FromUser" value="">
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba el valor</div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="control-label" for="fromdomain">FromDomain</label>
                                                    <input type="text" name="fromdomain" class="form-control" id="fromdomain" placeholder="FromDomain" value="">
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba el valor</div>
                                                </div>
                                            </div>
...
<!--                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="cid_number" class="form-control" id="cid_number" placeholder="Número de CallerID" value="">
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba la clave</div>
                                                </div>-->
                                            </div>
                                            <button class="btn btn-primary" type="submit">Crear Troncal</button>
