...
<head>
    ...
    <title>NO PERMITIDO - MarketHub - Gestión de Ventas.</title>
    ...
    <h1>Hmmm... No tienes permiso para estar en este lugar.</h1>
    <h2>Intenta <a href="#" onclick="history.back()">Volver</a></h2>
    <h2>O ir al <a href="#" onclick="window.location.assign('/')">Inicio</a></h2>
</body>
<script>
