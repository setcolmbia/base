                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="needs-validation" novalidate action="?controller=recordings&method=store" method="POST" enctype="multipart/form-data">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="file" class="form-control" name="file" id="file"  accept="audio/wav" placeholder="El formato del audio deber .wav" title="El formato del audio deber .wav" required>
                                                    <div class="valid-feedback">Correcto!</div>
