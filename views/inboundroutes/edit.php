                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3>Edición de la Ruta de Entrada</h3>
                                    </div>
                                    <div class="card-body">
                                        <form class="needs-validation" novalidate action="?controller=inboundroutes&method=update&id=<?= $inboundroutes->id ?>" method="POST" enctype="multipart/form-data">
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    <label for="name">DID</label>
                                                    <input type="text" class="form-control" id="did" name="did" placeholder="Escriba el DID de la Ruta de Entrada" value="<?= $inboundroutes->did ?>" title="Escriba el DID de la Ruta de Entrada" pattern="[A-Za-z0-9_ ]+" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                                    <div class="invalid-feedback">Escriba el DID de la Ruta de Entrada</div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="name">Nombre</label>
                                                    <input type="text" class="form-control" id="name" name="name" placeholder="Escriba el nombre de la Ruta de Entrada" value="<?= $inboundroutes->name ?>" title="Escriba el nombre de la Ruta de Entrada" pattern="[A-Za-z0-9_ ]+" required>
                                                    <div class="valid-feedback">Correcto!</div>
                                            ...
                                            <div class="form-row">
                                                <?php 
                                                    $option1 = $inboundroutes->dest;
                                                    $idDest = $inboundroutes->idDest;
                                                    if($idDest){
        ...
        function mostrarOpcion($idOpcion){
            switch ($idOpcion) {
                ...
                case 'ivrs':
                    ...
                    break;
                case 'inboundroutes':
                    echo "<option value='inboundroutes'>Horario</option>";
                    break;
                case 'shortcodes':
