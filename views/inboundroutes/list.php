                ...
                <div class="content">
                    <div class="page-inner">
                        ...
                        if (isset($_POST['name']) ) {
                            ...
                            die("SIN DATOS PARA BUSCAR Rutas de Entrada 1");
                        }
                        if($_POST['name'] == '' ){
                            die("SIN DATOS PARA BUSCAR Rutas de Entrada 2");
                        }
                        ?>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="?controller=inboundroutes&method=create" data-toggle="tooltip" title="Agregar Ruta de Entrada" data-placement="bottom" class="btn btn-primary">
                                            <i class="fas fa-user-plus"></i> Agregar Ruta de Entrada
                                        </a>
                                        <a href="?controller=inboundroutes&method=reload" data-toggle="tooltip" title="Recargar Configuración" data-placement="bottom" class="btn btn-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive" style="display: none;">
                                            <table id="tabla-loader-100" class="table table-hover table-striped table-binvoiceed display" width="100%">
                                                ...
                                                <?php foreach(parent::findByAny($name) as $inboundroutes):  ?>
                                                    <tr>
                                                        <td><?= $inboundroutes->id ?></td>
                                                        <td><?= $inboundroutes->did ?></td>
                                                        <td><?= $inboundroutes->name ?></td>
                                                        <td width="200" class="table__options">
                                                            <a href="?controller=inboundroutes&method=edit&id=<?= $inboundroutes->id ?>" data-toggle="tooltip" title="Editar la Ruta de Entrada" data-placement="bottom" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Editar</a>
                                                            <a href="?controller=inboundroutes&method=delete&id=<?= $inboundroutes->id ?>" data-toggle="tooltip" title="Eliminar la Ruta de Entrada" data-placement="bottom" class="btn btn-danger btn-sm" onclick='return asegurar()'><i class="fa fa-trash"></i> Borrar</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                                </tbody>
