                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="?controller=user&method=create" data-toggle="tooltip" title="Agregar Usuario" data-placement="bottom" class="btn btn-primary">
                                            ...
                                            <table id="basic-datatables" class="display table table-striped table-hover" >
                                                ...
                                                <?php foreach(parent::all() as $user):  ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $user->email ?></td>
                                                        <td><?= $user->company ?></td>
                                                        <td><?php echo ($user->active==1)?"SI":"NO"; ?></td>
                                                        <td width="200" class="table__options">
                                                            <a href="?controller=user&method=edit&id=<?= $user->id ?>" data-toggle="tooltip" title="Editar el Usuario" data-placement="bottom" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Editar</a>
                                                            <a href="?controller=user&method=editPassword&id=<?= $user->id ?>" data-toggle="tooltip" title="Cambiar Clave" data-placement="bottom" class="btn btn-primary btn-sm"><i class="fa fa-user-lock"></i> Clave</a>
                                                            <a href="?controller=user&method=delete&id=<?= $user->id ?>" data-toggle="tooltip" title="Eliminar el Usuario" data-placement="bottom" class="btn btn-danger btn-sm" onclick='return asegurar()'><i class="fa fa-trash"></i> Borrar</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                                </tbody>
